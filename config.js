...
global.linkGC = ['https://chat.whatsapp.com/EOoPdP0tepKAT19ZuWT78O']
global.Owner = {
  // use the phone number with the country code, for example Indonesia '62' America '1' etc
  '6289675134806': { // put your number here
    name: 'Owner Emilia-MD',
    isDev: true, // if true this number will send if bot have bug and developer mode true
    isReport: true, // if true this number will send if user use command /report or /join
    isCreator: true // if true this number will send if user use command /owner or /creator
  }
global.mods = ['6289675134806'] // Want some help?
...
// Sticker WM
global.packname = '@bangreyy_54'
global.author = 'Emilia-MD'
